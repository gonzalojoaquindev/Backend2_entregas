...
let resultado = await mongoose.connection.collection("villanos").deleteMany({})
console.log(resultado)
resultado = await mongoose.connection.collection("villanos").insertMany(villanos)
console.log(resultado)
